...
namespace Scrypt
{
    class Program
    {
        ...
        private static string DoScrypt()
        {
            return BitConverter.ToString(Scrypt.Encode("pleaseletmein", "saltsalt", 16384, 8, 1, 256));
            //return BitConverter.ToString(Scrypt.Encode("pleaseletmein", "SodiumChloride",
            //    1048576, 8, 1, 64));
        }
    }
}
